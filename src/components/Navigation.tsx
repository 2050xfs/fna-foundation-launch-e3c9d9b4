      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-1">
            ...
            <Link to="/donate">
              <Button variant="default" size="sm" className="ml-4 bg-success hover:bg-success/90 text-success-foreground">
                Donate Now
              </Button>
            </Link>
          </div>
          ...
          <div className="md:hidden py-4 border-t border-border">
            <div className="flex flex-col space-y-2">
              ...
              <Link to="/donate" onClick={() => setIsOpen(false)} className="px-4 py-2">
                <Button variant="default" size="sm" className="w-full bg-success hover:bg-success/90 text-success-foreground">
                  Donate Now
                </Button>
              </Link>
            </div>
