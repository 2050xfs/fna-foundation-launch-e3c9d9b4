    ...
    >
      <div className="grid gap-6 md:grid-cols-2">
        <FormField control={form.control} name="name" label="Your name" required>
          {(field) => <Input {...field} placeholder="Jordan Williams" />}
        </FormField>
      ...
      <FormField control={form.control} name="eventTitle" label="Event title" required>
        {(field) => <Input {...field} placeholder="Community Healing Circle" />}
      </FormField>
      ...
      <FormField
        ...
        required
      >
        {(field) => <Textarea {...field} rows={4} placeholder="This event would support Black youth ages 13+ by..." />}
      </FormField>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <FormField control={form.control} name="location" label="Proposed location" required>
          {(field) => <Input {...field} placeholder="West Oakland Youth Center" />}
        </FormField>
      </div>
      ...
      >
        {(field) => <Textarea {...field} rows={4} placeholder="Volunteers, healing practitioners, meals, funding for..." />}
      </FormField>
      ...
      <FormField
        ...
        required
      >
        {(field) => <Textarea {...field} rows={4} placeholder="This aligns with restorative justice because..." />}
      </FormField>
      ...
      >
        {(field) => <Textarea {...field} rows={3} placeholder="Share links, collaborators, or timing details." />}
      </FormField>
    </FormWrapper>
  );
};
